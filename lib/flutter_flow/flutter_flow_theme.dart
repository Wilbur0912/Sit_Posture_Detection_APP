...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4CC3FF);
  late Color secondary = const Color(0xFF8AFFC1);
  late Color tertiary = const Color(0xFFC4FFB2);
  late Color alternate = const Color(0xFFFFF2CC);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF2F2F7);
  late Color accent1 = const Color(0xFFFFB2B2);
  late Color accent2 = const Color(0xFFB2D8FF);
  late Color accent3 = const Color(0xFFF2A8FF);
  late Color accent4 = const Color(0xFFFFD1B2);
  late Color success = const Color(0xFFA8E6CF);
  late Color warning = const Color(0xFFFFF4E6);
  late Color error = const Color(0xFFFF9AA2);
  late Color info = const Color(0xFFB2CCFF);
